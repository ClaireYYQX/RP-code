...
metric = 'r2'
df = pd.read_csv(f'voxel_{metric}_mean_tbss.csv')
...
# Print the results
print(f"DTI = {mean_DTI:.2f} [{mean_DTI-ci_DTI:.2f}, {mean_DTI+ci_DTI:.2f}]")
print(f"FWE = {mean_FWE:.2f} [{mean_FWE-ci_FWE:.2f}, {mean_FWE+ci_FWE:.2f}]")